            ...
            >
                <SafeAreaView style={styles.mapContainer}>
                    <View style={styles.mapHeader}>
                        ...
                        <TouchableOpacity onPress={confirmMapSelection} disabled={!selectedLocation}>
                    ...
                    <View style={styles.searchContainer}>
                        <View style={styles.searchBar}>
                            <Ionicons name="search" size={20} color={Colors.greyDark} style={styles.searchIcon} />
                            <TextInput
                            ...
                            {mapSearchQuery.length > 0 && (
                                <TouchableOpacity onPress={() => {
                                    ...
                                    <Ionicons name="close-circle" size={18} color={Colors.greyDark} />
                                </TouchableOpacity>
                            )}
                        </View>
                            ...
                            <View style={styles.resultsList}>
                                <FlatList
                                    ...
                                    renderItem={({ item }) => (
                                        ...
                                        >
                                            <Ionicons name="location-outline" size={18} color={Colors.greyDark} />
